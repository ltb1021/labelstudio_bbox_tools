...
자세한 notebook 운영 정책은 [docs/notebook-workflow-guide.md](docs/notebook-workflow-guide.md)를 본다. 2차 고급 workflow는 [docs/workflow-labelstudio-advanced.md](docs/workflow-labelstudio-advanced.md)를 본다. 영상 frame 추출은 [docs/video-frame-extraction-guide.md](docs/video-frame-extraction-guide.md)를 본다. YOLO11/RF-DETR 영상 inference 비교는 [docs/video-inference-visualization-guide.md](docs/video-inference-visualization-guide.md)를 본다. 사람 pose 영상 inference 비교는 [docs/pose-video-inference-guide.md](docs/pose-video-inference-guide.md)를 본다.
