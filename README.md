...
Label Studio object detection bbox workflow를 정리한 Python package다. 이미지 import, MMYOLO/COCO JSON 기반 bbox UI 설정, annotation export, YOLO pseudo labeling, annotation/prediction merge, 기존 annotation import, project delete 보조 기능을 포함한다.
...
- dataset preprocessing/editing notebook 정리
...
6. `04_ls_pseudo_label_yolo.ipynb`: YOLO weight로 prediction 생성
7. `05_ls_merge_ann_pred.ipynb`: ann/pred source merge
8. `06_ls_import_annotations_mmyolo.ipynb`: 기존 MMYOLO annotation import
9. `99_ls_delete_project_safe.ipynb`: 위험 작업인 project 삭제 preview/delete
...
자세한 notebook 운영 정책은 [docs/notebook-workflow-guide.md](docs/notebook-workflow-guide.md)를 본다. 2차 고급 workflow는 [docs/workflow-labelstudio-advanced.md](docs/workflow-labelstudio-advanced.md)를 본다.
