...
Label Studio object detection bbox workflow를 정리한 Python package다. 영상 frame 추출, 이미지 import, MMYOLO/COCO JSON 기반 bbox UI 설정, annotation export, YOLO pseudo labeling, annotation/prediction merge, 기존 annotation import, project delete 보조 기능을 포함한다.
...
8. `05_ls_merge_ann_pred.ipynb`: ann/pred source merge
9. `06_ls_import_annotations_mmyolo.ipynb`: 기존 MMYOLO annotation import
10. `99_ls_delete_project_safe.ipynb`: 위험 작업인 project 삭제 preview/delete
